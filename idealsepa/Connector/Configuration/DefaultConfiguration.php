...
class DefaultConfiguration implements IConnectorConfiguration
{
    ...
    private function loadFromFile($path)
    {
		...
		if(isset($config_data['ACQUIRER']))
		{
			// Rabobank URL
			if( strpos( "rabobank", strtolower($config_data['ACQUIRER']) ) !== false )
			{
				if(isset($config_data['ACQUIRER_TEST']) && strtolower($config_data['ACQUIRER_TEST']) != "")
				{
					$config_data['ACQUIRERURL'] = "https://idealtest.rabobank.nl/ideal/iDEALv3";
				...
				{
					$config_data['ACQUIRERURL'] = "https://ideal.rabobank.nl/ideal/iDEALv3";
					$this->acquirerDirectoryURL = $config_data['ACQUIRERURL'];
					$this->acquirerStatusURL = $config_data['ACQUIRERURL'];
					$this->acquirerTransactionURL = $config_data['ACQUIRERURL'];
				}
			...
			// ING Bank
			if( strpos("ing bank", strtolower($config_data['ACQUIRER']) ) !== false )
			{
				if(isset($config_data['ACQUIRER_TEST']) && strtolower($config_data['ACQUIRER_TEST']) != "")
				{
			...
			// ABN Amro
			if( strpos("abn amro", strtolower($config_data['ACQUIRER']) ) !== false )
			{
				if(isset($config_data['ACQUIRER_TEST']) && strtolower($config_data['ACQUIRER_TEST']) != "")
				{
					//$config_data['ACQUIRERURL'] = "https://idealtest.secure-ing.com/ideal/iDEALv3";
					//$this->acquirerDirectoryURL = "https://idealm-et.abnamro.nl/nl/issuerInformation/";
					//$this->acquirerStatusURL = "https://idealm-et.abnamro.nl/nl/acquirerStatusInquirery/";
					//$this->acquirerTransactionURL = "https://idealm-et.abnamro.nl/nl/acquirerTrxRegistration/";
					$config_data['ACQUIRERURL'] = "https://abnamro-test.ideal-payment.de/ideal/iDEALv3";
					$this->acquirerDirectoryURL = $config_data['ACQUIRERURL'];
					$this->acquirerStatusURL = $config_data['ACQUIRERURL'];
					$this->acquirerTransactionURL = $config_data['ACQUIRERURL'];
				}
				else
				{
					...
					//$this->acquirerStatusURL = "https://idealm-et.abnamro.nl/nl/acquirerStatusInquirery/";
					//$this->acquirerTransactionURL = "https://idealm-et.abnamro.nl/nl/acquirerTrxRegistration/";
					$config_data['ACQUIRERURL'] = "https://abnamro.ideal-payment.de/ideal/iDEALv3";
					$this->acquirerDirectoryURL = $config_data['ACQUIRERURL'];
					$this->acquirerStatusURL = $config_data['ACQUIRERURL'];
					$this->acquirerTransactionURL = $config_data['ACQUIRERURL'];
				}
		...
		//die("URL: ".$config_data['ACQUIRERURL']." - ".$config_data['ACQUIRER_TEST']." - ".$config_data['ACQUIRER']);
